...
public class PlotPastGroup extends Step<PlotPastGroup.PlotPastGroupData> {
    ...
    public class PlotPastGroupData {
        String crop_thisSeason;
        String crop_thisSeason_other;
        String past_crop1;
        String other_past_crops1;
        String past_method1;
        String other_past_method_1;
        String past_crop2;
        String other_crop2;
        String past_method2;
    ...
    protected PlotPastGroup(String title) {
        super(title);
    }
    ...
    protected View createStepContentLayout() {
        ...
        PlotPastGroup.PlotPastGroupData plotPastGroupData = new PlotPastGroup.PlotPastGroupData();
