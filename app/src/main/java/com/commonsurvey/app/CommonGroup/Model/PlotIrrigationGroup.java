...
public class PlotIrrigationGroup extends Step<PlotIrrigationGroup.PlotIrrigationGroupData> {
    ...
    protected PlotIrrigationGroup(String title) {
        super(title);
    }
    ...
    protected View createStepContentLayout() {
        ...
        PlotIrrigationGroup.PlotIrrigationGroupData plotIrrigationGroupData = new PlotIrrigationGroup.PlotIrrigationGroupData();
